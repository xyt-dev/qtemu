...
Q_CONSTINIT static const qt_meta_stringdata_CLASSMyThreadENDCLASS_t qt_meta_stringdata_CLASSMyThreadENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(9, 11),  // "startSignal"
        QT_MOC_LITERAL(21, 0),  // ""
        QT_MOC_LITERAL(22, 10)   // "stopSignal"
    },
    "MyThread",
    "startSignal",
    "",
...
void MyThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &MyThread::startSignal; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MyThread::*)();
            if (_t _q_method = &MyThread::stopSignal; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MyThread::startSignal()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void MyThread::stopSignal()
{
